      ...
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-2">
          <Button variant="ghost" size="icon" asChild>
            <a
              href="https://www.linkedin.com/in/deniztuncbilek/"
              target="_blank"
          ...
          <Button variant="ghost" size="icon" asChild>
            <a href="https://github.com/deniz-tuncbilek" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
      ...
      <div className="md:hidden bg-background/95 backdrop-blur-xl border-b border-border px-6 pb-6 pt-2 space-y-1">
        ...
        <a
          ...
          <div className="flex gap-2 pt-4">
            <Button variant="ghost" size="icon" asChild>
              <a href="https://linkedin.com/in/deniztuncbilek" target="_blank" rel="noopener noreferrer">
                <Linkedin className="h-4 w-4" />
              </a>
            </Button>
            <Button variant="ghost" size="icon" asChild>
